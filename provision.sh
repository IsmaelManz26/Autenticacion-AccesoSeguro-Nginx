...
# Pagina de perfectlearn
sudo cp -r /vagrant/perfectlearnpage /var/www/perfectlearnpage
# Permisos carpeta
sudo chown www-data:www-data /etc/nginx/.htpasswd
sudo chmod 640 /etc/nginx/.htpasswd
# Enlace simbolico
sudo ln -s /etc/nginx/sites-available/perfectlearnpage /etc/nginx/sites-enabled/ 
# Permisos carpeta
sudo chown -R www-data:www-data /var/www/perfectlearn
sudo chmod -R 775 /var/www/perfectlearn
